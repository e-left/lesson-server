...
export default function Quotes() {
    ...
    useEffect(() => {
        fetch(process.env.api + "/ancientGreek/getQuote/")
            .then(res => res.json())
            .then(data => {
    ...
    const onSave = async () => {
        ...
        // save the quote
        const response = await fetch('/api/ancientGreek/setQuote', {
            method: 'POST',
            headers: {
    ...
    // clear handler
    const onClear = async () => {
        const response = await fetch('/api/ancientGreek/clearQuote/', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    return (
        <>
            <Head>
                <title>Ancient Greek Quote Editor</title>
            </Head>
                    ...
                    <div className="col justify-content-center">
                        <div className="row justify-content-center p-3 m-3">
                            <div className="col-auto">
                                <h3>Ancient Greek Quote Editor</h3>
                            </div>
                        </div>
